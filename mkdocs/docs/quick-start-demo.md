...
Now we are back to the ID Holder role. They will use their mobile application to authenticate themself by scanning the QR code generated by the issuer in the last step.
...
4. The process of generating proof is then started:  
